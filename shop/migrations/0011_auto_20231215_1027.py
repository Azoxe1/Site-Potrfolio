# Generated by Django 3.2.20 on 2023-12-15 10:27
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('state', models.CharField(choices=[('в процессе', 'Обработка'), ('в доставке', 'В доставке'), ('доставлено', 'Доставлено')], max_length=15, verbose_name='Статус')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('product_info', models.ForeignKey(blank=True, on_delete=django.db.models.deletion.CASCADE, related_name='ordered_items', to='shop.product', verbose_name='Информация о продукте')),
            ],
            options={
